...
from src.inventory.application.use_cases.commands import ActivateItemUseCase
...
class TestActivateItemUseCase:
    """Test suite for activate item use case"""
    ...
    async def test_execute_use_case_successfully(self) -> None:
        ...
        use_case = ActivateItemUseCase(repository=repo)
